describe('The Home Page', () => {
  beforeEach(() => {
    ...
    it('Successfully Books Opb-V6', () => {
      ...
      cy.wait(1000);
      cy.get('opb6-room-details .rates .rate-row-1 opb6-rate-details .btn-select', {timeout: 4000}).should('be.visible') 
      cy.get('opb6-room-details .rates .rate-row-1 opb6-rate-details .btn-select', {timeout: 4000}).click()
      cy.wait(1000);
